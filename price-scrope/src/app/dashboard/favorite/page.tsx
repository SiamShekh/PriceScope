...
import getFavoriteProduct from "@/server-actions/getFavoriteProduct";
    ...
    return (
        <div>
            <div className="uppercase relative pl-2">
                ...
                <p className="font-extrabold font-mono text-3xl text-black dark:text-white">favorite Product</p>
                <p className="font-mono text-2xl dark:text-white/60 text-black/60">The product you’ve marked as a favorite on our platform.</p>
            </div>
            {
                        ...
                        !data ? (
                            ...
                            data?.length === 0 ?
                                ...
                                data?.map((product: Product, i: number) => (
                                    <ProductItem type="delete" product={product} key={i} />
                                ))
                    }
                </div>
            }
